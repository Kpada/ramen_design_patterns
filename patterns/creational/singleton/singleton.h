...
class Food {
 public:
  ...
  void Eat() {
    std::cout << PrinterState::PlainText << "Someone is eating " << m_name
              << '\n';
  }
...
class Chef {
 public:
  ...
  Food CookRamen() { return Food("ramen"); }

  Food CookGyoza() { return Food("gyoza"); }

  Food CookUdon() { return Food("udon"); }
